    ...
    return (
        ...
        >
          <div className="password-recovry-wrap optn-btn-wrap">
              <button class="password-recovry-btn" onClick={()=>handleDelete('yes')}>Yes delete</button>
              <button class="password-recovry-btn green-btn" onClick={()=>handleDelete('no')}>No</button>
          </div>
        </ POPUP>
    );
  }
