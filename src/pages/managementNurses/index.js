                ...
                <div className="left-mid-dash-mgmnt">
                  ...
                  <div className="opertn_srch_main_wrapper_mgnt">
                    <div className="operation_search_tab_bar_mgnt">
                      ...
                      <div className="oprtn_urgncy_wrap operation_pdng mgnt_sort_by">
                        <span className="txt_urgncy">Sort by</span>{" "}
                        <span className="bld_txt_mgnt">Ward</span>
                  ...
                  <div class="dash_active_wrap oprtn_scroll_list reg_users_table">
                    <Table responsive>
                      ...
                      <tbody>
                        <tr>
                          <td className="bld_txt_mgnt width28">
                            <img
                              class="user_img"
                          ...
                          <td className="bld_txt_mgnt">
                            <span className="grncircl"></span>Active
                          </td>
                        </tr>
                        <tr>
                          <td className="bld_txt_mgnt">
