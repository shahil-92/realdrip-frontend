            ...
            <div class="mid-section-dshbrd">
              ...
              <div className="inner_dash">
                <div className="left-mid-dash">
                  ...
                  <div className="wrap_left_section">
                    ...
                    <div className="device_in_use_wrapper">
                      ...
                      >
                        <span className="idle_number">45</span>{" "}
                        <span className="idle_txt">Idle</span>
                      </SPAN_WRAPPER>
                    </div>
                    ...
                    <div className="device_in_use_wrapper time_left_wrapper">
                      ...
                      <div
                        className="device_inuse see_all_wrap"
                ...
                <div className="right-mid-dash">
                  <DashboardOperationWrap
                    wardInfusion={wardInfusion.data}
                    wardNurse={wardNurse.data}
                    {...this.props}
                  />
                </div>
              </div>
