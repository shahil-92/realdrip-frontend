                  ...
                  <div className="wrap_left_section">
                    <div className="dash_ward_device_wrap oprtn_wrap">
                        ...
                        <div className="wrpd_icon_num">
                          <span className="urgnt_txt">
                            <div className="wrapper_blood_flow">
                              ...
                              <span className="bloodflow">ml/h</span>{" "}
                      ...
                      <div className="infusn_wrap device_infusn  oprtn_dtl_wrd">
                        ...
                        <div className="thrd_progress_wrap">
                          <div className="wrapper_progress_bar middle_bar">
                            <div className="inner_progress_bar"></div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="input_row">
                            <div className="input_wrap">
                              ...
                              >
                                ...
                                <option value="set-stop-volume-2">
                                  set stop volume 2
                                </option>
                                <option value="set-stop-volume-3">
                                  set stop volume 3
                                </option>
                                <option value="set-stop-volume-4">
                                  set stop volume 4
                                </option>
                              </select>
                            </div>
