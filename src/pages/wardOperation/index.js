    ...
    <tbody>
     ...
     return(
         <tr className={(key === 0 ) ? "list_heading_ul ul_contnt active_dsh_list" : "list_heading_ul ul_contnt"}>    
             ...
             <td>
              <div className="speed_hr"> <span> 28 </span>  <span className="speed_unit bld_txt">ml/hr</span> </div>
             </td>
             <td>
            ...
            <div className="right_dashboard">
              ...
              <div class="mid-section-dshbrd">
                ...
                <div className="inner_dash">
                  ...
                  {activeTab==="active" &&  <div className="dash_ward_oprtn_wrap">
                      <REDCARD 
                  ...
                  {activeTab==="all" &&  <div className="dash_ward_oprtn_wrap">
                    <div className="infusn_nrse_wrap whiteBG">
                          <div className="oprtn_histry_img_wrap">
                              <img src={require('../../assets/Images/drip.png')} />
                          </div> 
