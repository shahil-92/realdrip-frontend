                ...
                <div className="right-mid-dash_mgnt">
                  <div className="wrap_dash_new_wrad">
                    <div className="img_heading_wrap_mgnt">
                      <img
                        className="img_ward_info"
                        src={ImageContainer.OPERATION_LARGE}
                      />
                  ...
                  <div className="ward_info_ul_wrap">
                    <div className="wrad_name_label_wrap">
                      <div className="ward_name">Ward Name</div>
                      <div className="ward_name">Ward Label</div>
                    </div>
                    <div className="wrad_name_label_wrap">
                      <div className="ward_label">Heart center</div>
                      <div className="ward_label">Ward B</div>
                    </div>
                  </div>
                  ...
                  <div className="two_img_cntnt_wrap">
                    <div className="img_cntnt_wrap">
                      <div className="img_info_list_wrap">
                        <img
                          className="img_info_list"
                          src={ImageContainer.DEVICE_LARGE}
                        />
                      </div>
                    ...
                    <div className="img_cntnt_wrap">
                      <div className="img_info_list_wrap">
                        <img
                          className="img_info_list"
                          src={ImageContainer.NURSE_LARGE}
                        />
                      </div>
                      <div className="wrad_img_txt">
                        <div className="ward_name_img_txt">Ward Name</div>
